    ...
    <h1><i class="far fa-edit"></i>Edit Data Dokter</h1>
    <br><hr><br>
    ...
    <?php 
        $id_dokter = $_GET['id'];
        $usernya =query("SELECT * FROM tb_dokter WHERE id_dokter='$id_dokter';");
    ?>
    <div class="login dashboard tbltidak">
        <form action="" method="post">
            ...
            <input type="hidden" value="<?= $usernya[0]['id_dokter'] ?>" name="id">
            <table class="tabel2">
                <tr>
                    <td>NIK</td>
                    <td>:</td>
